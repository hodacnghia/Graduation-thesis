...
for selected_market in range(15, 21):
    if selected_market == 1:
        ...
        save_result_to = 'byDistance_EURO100'
        ...
        save_result_to = 'byDistance_SSEC50'
    else:
        print("...")
