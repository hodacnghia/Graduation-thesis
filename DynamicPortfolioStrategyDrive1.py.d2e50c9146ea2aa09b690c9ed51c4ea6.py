...
for selected_market in range(1, 21):
    if selected_market == 1:
        ...
        save_result_to = 'byDegree_EURO100'
        ...
        save_result_to = 'byDegree_SSEC50'
    else:
        print("...")
